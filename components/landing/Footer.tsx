...
export default function Footer() {
	return (
		<>
			<footer className="relative bottom-0 min-h-[375px] w-full items-center justify-center overflow-hidden border-muted-foreground bg-[#266ae8] p-1 py-8 sm:p-8 md:px-10">
